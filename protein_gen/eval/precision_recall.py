# Based on https://github.com/youngjung/improved-precision-and-recall-metric-pytorch
...
class IPR():
	...
	def realism(self, feat):
		'''
		args:
			feat: feature embeddings
		'''
	...
	def compute_manifold(self, feats):
		...
		if isinstance(feats, str):
			if feats.endswith('.npz'):  # input is precalculated file
				print('loading', feats)
				f = np.load(feats)
				feats = f['feature']
				radii = f['radii']
				...
				raise ValueError("input should be a .npz file")
